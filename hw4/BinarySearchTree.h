...
private:
	...
	bool remove_no_child(Node *node, Node *parent, int value);
	bool remove_one_child(Node *node, Node *parent, int value);
	bool remove_two_child(Node *node, Node *parent, int value);
